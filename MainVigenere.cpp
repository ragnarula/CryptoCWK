//
// Created by Raghav Narula on 01/12/2016.
//
...
const option::Descriptor usage[] =
        {
                ...
                {KEY,     0, "k", "key",  Util::Required,    "  -k, --key key \t[REQUIRED] The key for the vigenere cipher. "},
...
int main(int argc, char *argv[]) {
    ...
    const Text plainText(str);

    Text cipherText = plainText;
    cipherText.vigenereAdd(options[KEY].arg);
